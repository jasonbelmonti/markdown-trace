...
export function checkInitialExample() {
  ...
  return { status: "pass", identifiers: identifiers.size, occurrences: occurrences.size,
    relationships: relationships.size, fragments: fragments.size, contextUtf8Bytes: ledger.queries.contextWP1Depth1.usedUtf8Bytes,
    scope: "Hand-authored ledger consistency only; no proposed API executed" };
}
