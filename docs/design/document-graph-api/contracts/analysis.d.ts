import type {
  AnalysisId, Diagnostic, EntityKind, FragmentId, Identifier,
  OccurrenceId, RelationshipId, RelationKind, Sha256, SourceIdentity, SourceRange,
} from "./source.js";
...
export type DefinitionState =
  ...
  | { readonly status: "duplicate"; readonly occurrenceIds: readonly [OccurrenceId, OccurrenceId, ...OccurrenceId[]] };
...
export type Owner =
  | { readonly status: "owned"; readonly identifier: Identifier; readonly declarationId: OccurrenceId }
  | { readonly status: "unowned" }
  | { readonly status: "ambiguous"; readonly declarationIds: readonly [OccurrenceId, OccurrenceId, ...OccurrenceId[]] };
...
export interface SourceFragment {
  ...
  readonly structure: "heading" | "paragraph" | "list-item" | "table-row" | "code" | "other";
...
export interface GraphSnapshot {
  ...
  readonly exclusions: readonly { readonly range: SourceRange; readonly reason: string }[];
