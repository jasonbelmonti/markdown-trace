...
EP-ACT-1 records the recommended lexical and ownership rules in the interface packet. The [rule/case index](corpus/manifest.json) contains 48 exact Markdown examples and independently authored interpretations. These are decision examples, not a completed graph/coordinate oracle; EP-ACT-2 materializes their paired fixtures and full expectations.
...
| LEX-2 | Explicit markers and preservation of unknown vocabulary | LANG-05, LANG-06 |
| LEX-3 | Exact raw source, no encoded or split-token reconstruction | LANG-07, LANG-08 |
| LEX-4 | Complete formatted tokens and visible labels; explicit HTML/metadata boundary | LANG-08 through LANG-13; LANG-46 |
| LEX-5 | Brace shielding and local malformed recovery | LANG-14 through LANG-19; LANG-29, LANG-30 |
...
| LEX-8 | Malformed groups do not leak inner references or cross line/cell boundaries | LANG-18, LANG-29, LANG-30, LANG-45 |
...
| OWN-5 | Explicit ambiguity with no outer or first-occurrence fallback | LANG-41 through LANG-43 |
| OWN-6 | Nested-container exits and resumption of outer ownership | LANG-33, LANG-35, LANG-36, LANG-38, LANG-48 |
| OWN-7 | Parent/child context partitioning and literal source context | LANG-26, LANG-44 |
