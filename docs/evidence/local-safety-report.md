...
| --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| sidecar validation | `markdown-trace validate --registry fixtures/r0-document-local-registry/entity-registry.yaml --document fixtures/r0-document-local-registry/execution-spec.md --report <tempdir>/valid-fixture-report.md` | `0` | 0 | none | `<tempdir>/valid-fixture-report.md` | `<tempdir>/valid-fixture-report.md` | `YES` | `NO` | none | `PASS` |
| derived registry generation | `markdown-trace derive --document fixtures/r0-document-local-registry/execution-spec.md --namespace exec --output <tempdir>/derived-registry-graph.yaml` | `0` | 0 | none | `<tempdir>/derived-registry-graph.yaml` | `<tempdir>/derived-registry-graph.yaml` | `YES` | `NO` | none | `PASS` |
