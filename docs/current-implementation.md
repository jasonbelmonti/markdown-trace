...
Cross-document resolution, projection-policy verification, representative scale measurement, stable API approval and publication remain follow-up work. The [task index](tasks/delegation-context/README.md) defines related capability contracts. Keep implementation over the document graph, not a recovered legacy registry or table model.
